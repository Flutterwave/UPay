      ...
      <ion-card class="card_padding">
        <ion-item>
          ...
          <ion-select
            ...
            @ionChange="paymentData.network = $event.target.value"
          >
            <ion-select-option
              :key="item.code"
              :value="item.code"
              ...
              <ion-item>
                ...
                >
                  <ion-select-option
                    ...
                    v-for="item in selectedNetworkDataPackage"
                    >{{ getDataValue(item.biller_name) }}
                  </ion-select-option>
                </ion-select>
              </ion-item>
            </ion-col>
...
export default {
  ...
  watch: {
    "paymentData.network": function (val) {
      ...
      let selectedNetwork = this.networks.filter((item) => {
